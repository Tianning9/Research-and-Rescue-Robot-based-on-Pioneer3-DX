...
if("TRUE" STREQUAL "TRUE")
  set(get_obj_dist_SOURCE_PREFIX /home/zhouru2/pro/src/ROS_human_detection/get_obj_dist)
  set(get_obj_dist_DEVEL_PREFIX /home/zhouru2/pro/devel)
  ...
  set(get_obj_dist_INSTALL_PREFIX /home/zhouru2/pro/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'get_obj_dist' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhouru2/pro/src/ROS_human_detection/get_obj_dist/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT get_obj_dist_NUM_DUMMY_TARGETS)
      set(get_obj_dist_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::get_obj_dist::wrapped-linker-option${get_obj_dist_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR get_obj_dist_NUM_DUMMY_TARGETS "${get_obj_dist_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::get_obj_dist::wrapped-linker-option${get_obj_dist_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND get_obj_dist_LIBRARIES "${interface_target_name}")
